...
public class DataManagementController {
  ...
  public CompletableFuture<ResponseEntity<?>> getZenohCatalog(
      @RequestBody CatalogRequest catalogRequest) throws Exception {
    log.info(
        "Received request for getting Zenoh catalog with search params: {}",
        catalogRequest.toString());
    return dataManagementService
        .getCatalogInfo(catalogRequest)
