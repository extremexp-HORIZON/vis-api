...
public class MetricDefinition {
  ...
  /** A brief explanation of what the metric represents. This field is optional. */
  private String description;

  /**
   * A standardized metric type (e.g., "accuracy", "precision", "f1-score"). This field is optional.
   */
  private String semanticType;

  /** The unit of measurement (e.g., percentage, seconds). This field is optional. */
  private String unit;

  /** Whether a higher value is considered better. This field is optional. */
