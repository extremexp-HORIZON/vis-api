...
/**
 * Summary of model evaluation metrics and metadata. Structured to align with standard scikit-learn
 * terminology.
 */
public record ModelEvaluationSummary(
  ...
  public record ClassReportEntry(
      String label, double precision, double recall, double f1Score, int support) {}
}
