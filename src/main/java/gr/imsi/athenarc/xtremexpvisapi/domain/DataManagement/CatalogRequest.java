...
public class CatalogRequest {
  ...
  public Map<String, String> toMap() {
    ...
    if (use_case != null) params.put("use_case", use_case);
    if (project_id != null && !project_id.isEmpty())
      params.put("project_id", String.join(",", project_id));
    if (created_from != null) params.put("created_from", created_from);
    if (created_to != null) params.put("created_to", created_to);
    if (useId != null) params.put("useId", useId);
    if (file_type != null) params.put("file_type", file_type);
    if (parent_files != null) params.put("parent_files", parent_files);
    if (size_from != null) params.put("size_from", size_from);
    if (size_to != null) params.put("size_to", size_to);
