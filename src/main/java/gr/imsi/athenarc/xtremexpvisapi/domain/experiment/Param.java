...
/**
 * Represents a key-value pair used as an input parameter for a run. Parameters typically define the
 * configuration of an experiment, such as hyperparameters for training models.
 */
public class Param {
