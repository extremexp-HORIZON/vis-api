...
/** Represents an experiment, which serves as a top-level container for multiple runs. */
public class Experiment {

  /** Unique identifier for the experiment. */
  private String id;

  /** A human-readable name that identifies the experiment. This field is optional. */
  private String name;
  ...
  /**
   * Unix timestamp of the last modification of the experiment (in milliseconds). This field is
   * optional.
   */
  private Long lastUpdateTime;

  /** Definitions of metrics tracked within this experiment. This field is optional. */
