...
/**
 * Abstraction for execution engines (Kubeflow, Airflow, etc.) Defines the contract for pipeline
...
public interface ExecutionEngine {
   ...
   * @throws ExecutionEngineException if the operation fails
   */
  String createRun(String pipelineId, String runName, Map<String, String> params)
