...
public class DataManagementService {
  ...
  private HttpRequest.Builder requestBuilder(String path) {
    ...
    return HttpRequest.newBuilder().uri(URI.create(baseUrl + "/file/" + path));
  }
  ...
  public CompletableFuture<CatalogResponse> getCatalogInfo(CatalogRequest catalogRequest)
      throws Exception {
    Map<String, String> params = new HashMap<>();
    HttpRequest request =
        requestBuilder("/catalog" + buildQueryString(catalogRequest.toMap())).GET().build();
