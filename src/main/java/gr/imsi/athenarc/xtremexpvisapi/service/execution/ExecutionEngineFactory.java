...
/**
 * Factory for selecting the appropriate execution engine based on configuration.
 * Supports pluggable execution engines (Kubeflow, Airflow, etc.)
 */
@Component
public class ExecutionEngineFactory {
    ...
    public ExecutionEngineFactory(Map<String, ExecutionEngine> executionEngines,
    ...
    public ExecutionEngine getExecutionEngine() {
        ...
        if (engine == null) {
            throw new IllegalArgumentException("Execution engine not found: " + configuredEngine + 
                    ". Available engines: " + executionEngines.keySet());
        }
        return engine;
    }
    ...
    public ExecutionEngine getExecutionEngine(String engineName) {
        ...
        if (engine == null) {
            throw new IllegalArgumentException("Execution engine not found: " + engineName + 
                    ". Available engines: " + executionEngines.keySet());
        }
        return engine;
    }
