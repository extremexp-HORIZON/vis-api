...
public class TimeSeriesQueryExecutor {
  ...
  public Table queryTabularData(Table table, TimeSeriesRequest timeSeriesRequest) {
          ...
          switch (columnTypeName) {
            ...
            case "LOCAL_DATE":
              ...
              try {
                ...
                throw new IllegalArgumentException(
                    "Min and Max must be of type LocalDate for column: "
                        + equalsFilter.getColumn());
              }
              LOG.debug(
                  "Date range filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
    ...
    resultTable =
        applyPagination(resultTable, timeSeriesRequest.getLimit(), timeSeriesRequest.getOffset());
