...
import gr.imsi.athenarc.xtremexpvisapi.domain.queryv1.params.filter.InequalityFilter;
import gr.imsi.athenarc.xtremexpvisapi.domain.queryv1.params.filter.RangeFilter;
import gr.imsi.athenarc.xtremexpvisapi.domain.queryv1.params.filter.StringFilter;
...
public class TabularQueryExecutor {
  ...
  public QueryResult queryTabularData(Table table, TabularRequest tabularRequest) {
        ...
        if (filter instanceof RangeFilter) {
          ...
          switch (columnTypeName) {
            case "DOUBLE":
              ...
              LOG.debug(
                  "Number range filtering {}, with min {} and max {}",
                  rangeFilter.getColumn(),
                  rangeFilter.getMin(),
                  rangeFilter.getMax());
              filterSelection =
                  table
                      .numberColumn(rangeFilter.getColumn())
            ...
            case "INTEGER":
              ...
              LOG.debug(
                  "Integer range filtering {}, with min {} and max {}",
                  rangeFilter.getColumn(),
                  rangeFilter.getMin(),
                  rangeFilter.getMax());
              filterSelection =
                  table
                      .intColumn(rangeFilter.getColumn())
            ...
            case "LOCAL_DATE_TIME":
              ...
              LOG.debug(
                  "Date range filtering {}, with min {} and max {}",
                  rangeFilter.getColumn(),
                  rangeFilter.getMin(),
                  rangeFilter.getMax());
              filterSelection =
                  table
                      .dateTimeColumn(rangeFilter.getColumn())
            ...
            case "LOCAL_DATE":
              ...
              LOG.debug(
                  ...
                  rangeFilter.getMax());
              filterSelection =
                  table.dateColumn(rangeFilter.getColumn()).isBetweenIncluding(minDate, maxDate);
              break;
            case "LOCAL_TIME":
              LocalTime minTime;
              LocalTime maxTime;
              ...
              filterSelection =
                  table
                      .timeColumn(rangeFilter.getColumn())
                      .isOnOrAfter(minTime)
                      .and(table.timeColumn(rangeFilter.getColumn()).isOnOrBefore(maxTime));
              break;
            case "INSTANT":
              Instant minInstant;
              Instant maxInstant;
              ...
              filterSelection =
                  table
                      .instantColumn(rangeFilter.getColumn())
                      .isAfter(minInstant)
                      .and(table.instantColumn(rangeFilter.getColumn()).isBefore(maxInstant));
              break;
            default:
              throw new IllegalArgumentException(
          ...
          switch (columnTypeName) {
            case "BOOLEAN":
              LOG.debug(
                  "Double equals filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
              boolean booleanValue =
                  Boolean.parseBoolean(equalsFilter.getValue().toString().toLowerCase());
              if (booleanValue) {
            ...
            case "INTEGER":
              ...
              LOG.debug(
                  "Integer equals filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
            ...
            case "STRING":
              ...
              LOG.debug(
                  "String equals filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
              filterSelection =
                  table
                      .stringColumn(equalsFilter.getColumn())
            ...
            case "LOCAL_DATE_TIME":
              ...
              LOG.debug(
                  "DateTime equals filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
              filterSelection =
                  table.dateTimeColumn(equalsFilter.getColumn()).isEqualTo(localDateTimeValue);
              break;
            case "LOCAL_DATE":
              LocalDate date;
              try {
              ...
              LOG.debug(
                  "Date equals filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
              filterSelection = table.dateColumn(equalsFilter.getColumn()).isEqualTo(date);
              break;
            case "LOCAL_TIME":
              LocalTime timeValue;
              try {
              ...
              LOG.debug(
                  "Time equals filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
              filterSelection = table.timeColumn(equalsFilter.getColumn()).isEqualTo(timeValue);
              break;
            case "INSTANT":
              ...
              LOG.debug(
                  "Instant equals filtering {}, with value {}",
                  equalsFilter.getColumn(),
                  equalsFilter.getValue());
              filterSelection =
                  table.instantColumn(equalsFilter.getColumn()).isEqualTo(instantValue);
              break;
            default:
              throw new IllegalArgumentException(
          ...
          switch (columnTypeName) {
            case "DOUBLE":
              ...
              LOG.debug(
                  "Double inequality filtering {}, with value {} and operator {}",
                  inequalityFilter.getColumn(),
                  inequalityFilter.getValue(),
                  operator);

              switch (operator) {
                case "gt":
                  filterSelection =
                      table.doubleColumn(inequalityFilter.getColumn()).isGreaterThan(doubleValue);
                  break;
                case "lt":
                  filterSelection =
                      table.doubleColumn(inequalityFilter.getColumn()).isLessThan(doubleValue);
                  break;
                case "gte":
                  filterSelection =
                      table
                          .doubleColumn(inequalityFilter.getColumn())
                          .isGreaterThanOrEqualTo(doubleValue);
                  break;
                case "lte":
                  filterSelection =
                      table
                          .doubleColumn(inequalityFilter.getColumn())
                          .isLessThanOrEqualTo(doubleValue);
                  break;
                default:
            ...
            case "INTEGER":
              ...
              LOG.debug(
                  "Integer inequality filtering {}, with value {} and operator {}",
                  inequalityFilter.getColumn(),
                  inequalityFilter.getValue(),
                  operator);
              ...
              switch (operator) {
                case "gt":
                  filterSelection =
                      table.intColumn(inequalityFilter.getColumn()).isGreaterThan(intValue);
                  break;
                case "lt":
                  filterSelection =
                      table.intColumn(inequalityFilter.getColumn()).isLessThan(intValue);
                  break;
                case "gte":
                  filterSelection =
                      table
                          .intColumn(inequalityFilter.getColumn())
                          .isGreaterThanOrEqualTo(intValue);
                  break;
                case "lte":
                  filterSelection =
                      table.intColumn(inequalityFilter.getColumn()).isLessThanOrEqualTo(intValue);
                  break;
                default:
                  throw new IllegalArgumentException("Unsupported operator: " + operator);
              }
            ...
            case "LOCAL_DATE_TIME":
              ...
              try {
                ...
                throw new IllegalArgumentException(
                    "Value must be of type LocalDateTime for column: "
                        + inequalityFilter.getColumn());
              }
              ...
              switch (operator) {
                case "gt":
                  filterSelection =
                      table.dateTimeColumn(inequalityFilter.getColumn()).isAfter(dateTimeValue);
                  break;
                case "lt":
                  filterSelection =
                      table.dateTimeColumn(inequalityFilter.getColumn()).isBefore(dateTimeValue);
                  break;
                case "gte":
                  filterSelection =
                      table.dateTimeColumn(inequalityFilter.getColumn()).isOnOrAfter(dateTimeValue);
                  break;
                case "lte":
                  filterSelection =
                      table
                          .dateTimeColumn(inequalityFilter.getColumn())
                          .isOnOrBefore(dateTimeValue);
                  break;
                default:
                  throw new IllegalArgumentException("Unsupported operator: " + operator);
              }
            ...
            case "LOCAL_DATE":
              ...
              switch (operator) {
                case "gt":
                  filterSelection =
                      table.dateColumn(inequalityFilter.getColumn()).isAfter(dateValue);
                  break;
                case "lt":
                  filterSelection =
                      table.dateColumn(inequalityFilter.getColumn()).isBefore(dateValue);
                  break;
                case "gte":
                  filterSelection =
                      table.dateColumn(inequalityFilter.getColumn()).isOnOrAfter(dateValue);
                  break;
                case "lte":
                  filterSelection =
                      table.dateColumn(inequalityFilter.getColumn()).isOnOrBefore(dateValue);
                  break;
                default:
                  throw new IllegalArgumentException("Unsupported operator: " + operator);
              }
            ...
            case "LOCAL_TIME":
              ...
              switch (operator) {
                case "gt":
                  filterSelection =
                      table.timeColumn(inequalityFilter.getColumn()).isAfter(timeValue);
                  break;
                case "lt":
                  filterSelection =
                      table.timeColumn(inequalityFilter.getColumn()).isBefore(timeValue);
                  break;
                case "gte":
                  filterSelection =
                      table.timeColumn(inequalityFilter.getColumn()).isOnOrAfter(timeValue);
                  break;
                case "lte":
                  filterSelection =
                      table.timeColumn(inequalityFilter.getColumn()).isOnOrBefore(timeValue);
                  break;
                default:
                  throw new IllegalArgumentException("Unsupported operator: " + operator);
              }
            ...
            case "INSTANT":
              ...
              switch (operator) {
                case "gt":
                  filterSelection =
                      table.instantColumn(inequalityFilter.getColumn()).isAfter(instantValue);
                  break;
                case "lt":
                  filterSelection =
                      table.instantColumn(inequalityFilter.getColumn()).isBefore(instantValue);
                  break;
                case "gte":
                  // There's no direct isOnOrAfter for Instant, so we combine isEqual and isAfter
                  filterSelection =
                      table
                          .instantColumn(inequalityFilter.getColumn())
                          .isEqualTo(instantValue)
                          .or(
                              table
                                  .instantColumn(inequalityFilter.getColumn())
                                  .isAfter(instantValue));
                  break;
                case "lte":
          ...
          if (!columnTypeName.equals("STRING")) {
            throw new IllegalArgumentException(
                "String filter can only be applied to STRING columns, but column type is: "
                    + columnTypeName);
          }
          ...
          LOG.debug(
              "String filtering {}, with value {} and operator {}",
              stringFilter.getColumn(),
              value,
              operator);
    ...
    if (tabularRequest.getAggregation() != null && !tabularRequest.getAggregation().isEmpty()) {
      resultTable =
          applyAggregation(
              resultTable, tabularRequest.getGroupBy(), tabularRequest.getAggregation());
    }

    resultTable =
        applyPagination(resultTable, tabularRequest.getLimit(), tabularRequest.getOffset());
  ...
  private Table applyAggregation(
      Table table, List<String> groupByColumns, Map<String, Object> aggregation) {
    ...
    for (Map.Entry<String, Object> agg : aggregation.entrySet()) {
      ...
      if (aggFunctions instanceof List) {
        ...
        for (String aggFunction : aggList) {
          resultTable =
              applySingleAggregation(table, groupByColumns, resultTable, column, aggFunction);
        }
  ...
  private Table applySingleAggregation(
      Table table,
    ...
    switch (aggFunction.toLowerCase()) {
      case "sum":
        if (globalAggregation) {
          aggregatedTable =
              table.summarize(column, AggregateFunctions.sum).apply(); // Global aggregation
        } else {
          aggregatedTable =
              table
                  .summarize(column, AggregateFunctions.sum)
      ...
      case "avg":
        if (globalAggregation) {
          aggregatedTable =
              table.summarize(column, AggregateFunctions.mean).apply(); // Global aggregation
        } else {
          aggregatedTable =
              table
                  .summarize(column, AggregateFunctions.mean)
                  .by(groupByColumns.toArray(new String[0]));
        }
        break;
      case "count":
        if (globalAggregation) {
          aggregatedTable =
              table.summarize(column, AggregateFunctions.count).apply(); // Global aggregation
        } else {
          aggregatedTable =
              table
                  .summarize(column, AggregateFunctions.count)
                  .by(groupByColumns.toArray(new String[0]));
        }
        break;
      case "max":
        if (globalAggregation) {
          aggregatedTable =
              table.summarize(column, AggregateFunctions.max).apply(); // Global aggregation
        } else {
          aggregatedTable =
              table
                  .summarize(column, AggregateFunctions.max)
                  .by(groupByColumns.toArray(new String[0]));
        }
        break;
      case "min":
        if (globalAggregation) {
          aggregatedTable =
              table.summarize(column, AggregateFunctions.min).apply(); // Global aggregation
        } else {
          aggregatedTable =
              table
                  .summarize(column, AggregateFunctions.min)
                  .by(groupByColumns.toArray(new String[0]));
        }
        break;
      default:
