...
class ZoneServiceTest {
    ...
    @Test
    void testSaveZoneWithAutoGeneratedId() {
        // Arrange
        Zone zone = new Zone();
    ...
    @Test
    void testSaveZoneWithProvidedId() {
        // Arrange
        Zone zone = new Zone();
    ...
    @Test
    void testSaveZoneWithMissingRequiredFields() {
        // Arrange
        Zone zone = new Zone();
        zone.setFileName("test.csv");
        // Missing name field
    ...
    @Test
    void testSaveZoneWithMissingFileName() {
        // Arrange
        Zone zone = new Zone();
        zone.setName("Test Zone");
    ...
    @Test
    void testSaveZoneWithWhitespaceId() {
        // Arrange
        Zone zone = new Zone();
    ...
    @Test
    void testSaveZoneWithProvidedIdStillWorks() {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneWithExistingIdConflict() {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZonePreservesExistingData() {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneWithAllFields() {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneRepositoryFailure() {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testSaveZoneWithRectangle() {
        // Arrange
        Zone zone = new Zone();
        zone.setFileName("test.csv");
    ...
    @Test
    void testSaveZoneWithCompleteData() {
        // Arrange
        Zone zone = new Zone();
    ...
    void testGetZoneFilePathSuccessfully() {
        // Arrange
        String fileName = "test.csv";
        String expectedPath = "/path/to/zones/test.csv.json";
        
        when(zoneRepository.getZoneFilePath(fileName)).thenReturn(java.nio.file.Path.of(expectedPath));
        
        // Act
        String actualPath = zoneService.getZoneFilePath(fileName);
        
        // Assert
        assertEquals(expectedPath, actualPath);
        
        // Verify repository was called
        verify(zoneRepository).getZoneFilePath(fileName);
    }
    ...
    void testGetZoneFilePathWithEmptyFileName() {
        ...
        // Act & Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            zoneService.getZoneFilePath(fileName);
        });
        
        assertEquals("FileName cannot be null or empty", exception.getMessage());
        
        // Verify repository was NOT called
        verify(zoneRepository, never()).getZoneFilePath(any());
    }
}
