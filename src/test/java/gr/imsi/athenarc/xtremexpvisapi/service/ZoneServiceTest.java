...
class ZoneServiceTest {
    ...
    @Test
    void testSaveZoneWithAutoGeneratedId() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
    ...
    @Test
    void testSaveZoneWithProvidedId() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
    ...
    @Test
    void testSaveZoneWithMissingRequiredFields() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setFileName("test.csv");
        // Missing name field
    ...
    @Test
    void testSaveZoneWithMissingFileName() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setName("Test Zone");
    ...
    @Test
    void testSaveZoneWithNullZone() throws JsonProcessingException  {
        // Act & Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    void testSaveZoneWithEmptyId() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId(""); // Empty ID
        zone.setFileName("test.csv");
    ...
    @Test
    void testSaveZoneWithWhitespaceId() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
    ...
    @Test
    void testSaveZoneWithProvidedIdStillWorks() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneSuccessfully() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneWithNullId() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
    ...
    @Test
    void testUpdateZoneWithEmptyId() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId(""); // Empty ID
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneWithWhitespaceId() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId("   "); // Whitespace ID
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneWithExistingIdConflict() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZonePreservesExistingData() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneWithAllFields() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testUpdateZoneRepositoryFailure() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setId("existing-zone-123");
        zone.setFileName("test.csv");
    ...
    @Test
    void testSaveZoneWithRectangle() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setFileName("test.csv");
        ...
        zone.setGeometry(new GeoJsonPoint(List.of(0.0, 0.0)));
        ...
        assertTrue(savedZone.getGeometry() instanceof GeoJsonPoint);
        GeoJsonPoint geometryPoint = (GeoJsonPoint) savedZone.getGeometry();
    ...
    @Test
    void testSaveZoneWithHeights() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
        zone.setFileName("test.csv");
    ...
    @Test
    void testSaveZoneWithCompleteData() throws JsonProcessingException {
        // Arrange
        Zone zone = new Zone();
